                            ...
                            <tbody>
                                ...
                                @foreach ($solicitacoes as $solicitacao)
                                    <tr>
                                        ...
                                        <td><a href="#modal-aprovacao-{{ $solicitacao->id }}"
                                                data-toggle="modal">{{ $solicitacao->usuario->nome }}</a></td>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a
                                                    href="{{ $url_base }}/upload/razao/{{ $solicitacao->anexo }}">{{ $solicitacao->anexo }}</a>
                                        </td>
                                @endif
                                <td>
                                ...
                                <div id="modal-aprovacao-{{ $solicitacao->id }}" class="modal fade" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <form method="post" action="/painel/certificacao/salvar"
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <p>
                                                                ...
                                                                <label>Data:</label>:
                                                                {{ $solicitacao->data->format('d/m/Y') }}<br>
                                                                <label>Hora:</label>:
                                                                {{ substr($solicitacao->hora, 0, 5) }}<br>
                                                                <label>Justificativa:</label>:
                                                                {{ $solicitacao->pontoRazao->descricao }}<br>
                                                                <label>Anexo:</label>:
                                                                @if (empty($solicitacao->anexo))
                                                                    Sem anexo
                                                                @else
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="botao" value="sim"
                                                        class="btn btn-success">Aprovar</button>
                                                    <button type="submit" name="botao" value="nao"
                                                        class="btn btn-danger">Não aprovar</button>
                                                </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-4">
                                <input type="text" name="hora_entrada" class="form-control time"
                                    placeholder="Hora de Entrada" value="" required>
                            </div>
                            <div class="col-md-4">
                                <input type="text" name="hora_saida" class="form-control time"
                                    placeholder="Hora de Saída" value="" required>
                            </div>
                        </div>
