                ...
                <div class="box box-primary">
                    ...
                    <form id="formUsuario" method="post" action="{{ $url_base }}/painel/usuario/salvar">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nome</label>
                                        <input type="text" name="nome" maxlength="100" value="<?php print $return_nome; ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" name="email" maxlength="100" value="<?php print $return_email; ?>"
                                            class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Cargo</label>
                                        <input type="text" name="cargo" maxlength="100" value="<?php print $return_cargo; ?>"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Local</label>
                                        <input type="text" name="local" maxlength="100" value="<?php print $return_local; ?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>CPF</label>
                                        <input type="text" name="cpf" maxlength="14" value="<?php print $return_cpf; ?>"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="senha" name="senha" maxlength="12"
                                            class="form-control" <?php print $varRequired; ?>>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Confirmar senha</label><small id="has-error-resenha"></small>
                                        <input type="password" id="resenha" name="resenha" maxlength="12"
                                            class="form-control" <?php print $varRequired; ?>>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <button type="submit" id="razao-salvar"
                                class="btn btn-primary btnCadastro pull-right">Salvar</button>
                        </div>
